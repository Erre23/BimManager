    ...
    public class CreditNote : IXmlSerializable
    {
        ...
        public void WriteXml(XmlWriter writer)
        {
...

                            {
                                ...
                                foreach (var additionalMonetaryTotal in ext2.AdditionalMonetaryTotals)
                                {
...

                                    {
                                        ...
                                        writer.WriteValue(additionalMonetaryTotal.PayableAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
                                        writer.WriteEndElement();
                                    }
            ...
            foreach (var taxTotal in TaxTotals)
            {
                ...
                writer.WriteString(taxTotal.TaxAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
                writer.WriteEndElement();
            ...
            writer.WriteValue(LegalMonetaryTotal.PayableAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
            writer.WriteEndElement();
            ...
            foreach (var creditNoteLine in CreditNoteLines)
            {
                ...
                writer.WriteStartElement("cbc:CreditedQuantity");
                {
                    ...
                    writer.WriteValue(creditNoteLine.CreditedQuantity.Value.ToString(Constantes.Formatos.FormatoNumerico));
                }
                writer.WriteEndElement();
                #endregion
                ...
                writer.WriteStartElement("cbc:LineExtensionAmount");
                {
                    ...
                    writer.WriteValue(creditNoteLine.LineExtensionAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
                }
                writer.WriteEndElement();
                #endregion
                ...
                foreach (var item in creditNoteLine.PricingReference.AlternativeConditionPrices)
                {
                    ...
                    writer.WriteValue(item.PriceAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
                    writer.WriteEndElement();
                    #endregion
                ...
                if (creditNoteLine.AllowanceCharge.ChargeIndicator)
                {
                    ...
                    writer.WriteValue(creditNoteLine.AllowanceCharge.Amount.value.ToString(Constantes.Formatos.FormatoNumerico));
                    writer.WriteEndElement();
                    #endregion
                ...
                #region TaxTotal
                {
                    foreach (var taxTotal in creditNoteLine.TaxTotals)
                    {
                        ...
                        if (!string.IsNullOrEmpty(taxTotal.TaxableAmount.currencyID))
                        {
                            ...
                            writer.WriteString(taxTotal.TaxableAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
                            writer.WriteEndElement();
                        }
                        ...
                        if (taxTotal.TaxSubtotal.Percent > 0)
                            writer.WriteElementString("cbc:Percent", taxTotal.TaxSubtotal.Percent.ToString(Constantes.Formatos.FormatoNumerico));
                ...
                writer.WriteString(creditNoteLine.Price.PriceAmount.value.ToString(Constantes.Formatos.FormatoNumerico));
                writer.WriteEndElement();
