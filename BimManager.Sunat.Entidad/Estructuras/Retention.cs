...
namespace BimManager.Sunat.Entidad.Estructuras
{
    ...
    public class Retention : IXmlSerializable
    {
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteElementString("sac:SUNATRetentionPercent", SUNATRetentionPercent.ToString(Constantes.Formatos.FormatoNumerico, Formato));
            ...
            writer.WriteStartElement("cbc:TotalInvoiceAmount");
            {
                ...
                writer.WriteValue(TotalInvoiceAmount.value.ToString(Constantes.Formatos.FormatoNumerico, Formato));
            }
            writer.WriteEndElement();
            ...
            writer.WriteStartElement("sac:SUNATTotalPaid");
            {
                ...
                writer.WriteValue(TotalPaid.value.ToString(Constantes.Formatos.FormatoNumerico, Formato));
            }
            writer.WriteEndElement();
            ...
            foreach (var info in SUNATRetentionDocumentReference)
            {
                ...
                writer.WriteStartElement("cbc:TotalInvoiceAmount");
                {
                    ...
                    writer.WriteValue(info.TotalInvoiceAmount.value.ToString(Constantes.Formatos.FormatoNumerico, Formato));
                }
                writer.WriteEndElement();
                #endregion
                ...
                writer.WriteStartElement("cac:Payment");
                {
                    ...
                    writer.WriteStartElement("cbc:PaidAmount");
                    {
                        ...
                        writer.WriteValue(info.Payment.PaidAmount.value.ToString(Constantes.Formatos.FormatoNumerico, Formato));
                        writer.WriteEndElement();
                    }
                ...
                writer.WriteStartElement("sac:SUNATRetentionInformation");
                {
                    ...
                    writer.WriteStartElement("sac:SUNATRetentionAmount");
                    {
                        ...
                        writer.WriteValue(info.SUNATRetentionInformation.SUNATRetentionAmount.value.ToString(Constantes.Formatos.FormatoNumerico, Formato));
                    }
                    writer.WriteEndElement();
                    #endregion
                    ...
                    writer.WriteStartElement("sac:SUNATNetTotalPaid");
                    {
                        ...
                        writer.WriteValue(info.SUNATRetentionInformation.SUNATNetTotalPaid.value.ToString(Constantes.Formatos.FormatoNumerico, Formato));
                    }
                    writer.WriteEndElement();
                    #endregion
                    ...
                    writer.WriteStartElement("cac:ExchangeRate");
                    {
                        ...
                        writer.WriteElementString("cbc:CalculationRate", info.SUNATRetentionInformation.ExchangeRate.CalculationRate.ToString(Constantes.Formatos.FormatoNumerico, Formato));
